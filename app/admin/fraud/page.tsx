  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-xl border border-slate-200 space-y-2">
        ...
        <h1 className="text-2xl font-bold text-slate-900">Fraud Detection & Discrepancy Logs</h1>
        <p className="text-sm text-slate-500">
          Route: <code className="bg-slate-100 px-2 py-0.5 rounded">/admin/fraud</code>
        </p>
      </div>
      ...
      <div className="p-6 bg-slate-50 border border-dashed border-slate-300 rounded-xl space-y-4">
        ...
        <ul className="list-disc list-inside text-xs text-slate-600 space-y-1">
          <li>Build security alert log list for unverified MoMo payments or unrecorded services</li>
          <li>Implement alert resolution controls</li>
        </ul>
