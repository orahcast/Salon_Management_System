  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-xl border border-slate-200 space-y-2">
        ...
        <h1 className="text-2xl font-bold text-slate-900">Staff Leaderboard & Competition</h1>
        <p className="text-sm text-slate-500">
          Route: <code className="bg-slate-100 px-2 py-0.5 rounded">/barber/leaderboard</code>
        </p>
      </div>
      ...
      <div className="p-6 bg-slate-50 border border-dashed border-slate-300 rounded-xl space-y-4">
        ...
        <ul className="list-disc list-inside text-xs text-slate-600 space-y-1">
          <li>Build interactive staff rankings based on cuts completed today</li>
          <li>Display barber cut targets and achievement badges</li>
          <li>Add rank change micro-animations</li>
        </ul>
